...
# ----------------------------------------------------------------
POST_TITLE="${@:2:$(($#-1))}"
POST_NAME="$(echo ${@:2:$(($#-1))} | sed -e 's/ /-/g' | sed "y/ABCDEFGHIJKLMNOPQRSTUVWXYZÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖØÙÚÛÜüÝÞßàáâãäåæçèéêëìíîïðñòóôõöøùúûýýþÿ/abcdefghijklmnopqrstuvwxyzaaaaaaaceeeeiiiidnoooooouuuuuybsaaaaaaaceeeeiiiidnoooooouuuyyby/")"
...
echo "description: \"\""
echo "server: \"MediaFire\""
echo "status: true"
echo "size: \"\"" 
echo "download_link: \"\""
echo "download_page_link: \"\""
echo "original_link: \"\""
echo "---"
